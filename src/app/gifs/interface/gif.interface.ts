// To parse this data:
//
//   import { Convert, SearchGifrespose } from "./file";
//
//   const searchGifrespose = Convert.toSearchGifrespose(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifrespose {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifrespose(json: string): SearchGifrespose {
        return cast(JSON.parse(json), r("SearchGifrespose"));
    }

    public static searchGifresposeToJson(value: SearchGifrespose): string {
        return JSON.stringify(uncast(value, r("SearchGifrespose")), null, 2);
    }
}
